...
using Capstone_Olapp.ViewModel;
...
namespace Account.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IMapper mapper, KaskwekContext context, UserManager<ApplicationUser> usrMngr, SignInManager<ApplicationUser> signInMngr, ILogger<AccountController> logger)
        {
            _mapper = mapper;
            _context = context;
            _usrMngr = usrMngr;
        ...
        public async Task<ActionResult> Login(LoginViewModel login)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("noEmailFind ", "Email not registered.");
                    return View(login);
                }
            }
            return View();
